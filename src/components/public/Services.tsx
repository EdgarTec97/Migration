...
import CitaModal from "@/components/public/modals/Cita.modal";
import DemandModal from "@/components/public/modals/demand.modal";
import { toast } from "react-toastify";

export default function Services() {
  const [modalCitaIsOpen, setCitaModal] = useState<boolean>(false);
  const [modalDemandIsOpen, setDemandModal] = useState<boolean>(false);
  ...
  return (
    <>
              ...
              <ScrollAnimationWrapper className="flex justify-center">
                ...
                >
                  ...
                  <div className="flex flex-col w-full justify-center mb-8 flex-none mt-12">
                    ...
                    <ButtonOutline onClick={openCitaModal}>
                      Seleccionar
                    </ButtonOutline>
                  </div>
                </motion.div>
              ...
              <ScrollAnimationWrapper className="flex justify-center">
                ...
                >
                  ...
                  <div className="flex flex-col w-full justify-center mb-8 flex-none mt-12">
                    ...
                    <ButtonOutline onClick={openDemandModal}>
                      Seleccionar
                    </ButtonOutline>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="flex flex-col w-full justify-center mb-8 flex-none mt-12">
                    ...
                    <ButtonOutline
                      onClick={() => {
                        toast.info(
                          "Trabajando en implementar nuevos servicios"
                        );
                      }}
                    >
                      Deshabilitado
                ...
                <div className="flex flex-col sm:flex-row shadow-lg rounded-lg p-4 overflow-scroll">
                  <div className="w-full sm:w-1/3 bg-gray-100 flex items-center justify-center px-4 py-8">
                    <div>
                      ...
                      <p className="mb-4">
                        <strong>Dirección:</strong> 7 y 8 Morelos Piso 4,
                        Palacio Federal, Sector Centro, C.P. 87000, Cd.
                        Victoria, Tamaulipas.
                      </p>
                      <p className="mb-4">
          ...
          <div className="flex flex-col w-full my-4" id="testimoni">
            <ScrollAnimationWrapper>
              ...
              >
                ...
                requisitos y documentos del trámite migratorio que precisas,
                aquí te brindamos toda la información con su ubicación y formas
                de contacto. Todos los trámites tienen que ser ingresados de
                manera presencial en la delegación del INM de Ciudad Victoria.
              </motion.p>
            </ScrollAnimationWrapper>
      ...
      <CitaModal modalIsOpen={modalCitaIsOpen} closeModal={closeCitaModal} />
      <DemandModal
        modalIsOpen={modalDemandIsOpen}
        closeModal={closeDemandModal}
      />
    </>
  );
}
